  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glass-xl': '0 32px 64px -12px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.1)',
        'premium': '0 32px 64px -12px rgba(0, 0, 0, 0.4), 0 25px 50px -12px rgba(139, 92, 246, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.1)',
